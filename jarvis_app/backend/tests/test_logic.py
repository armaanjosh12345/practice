...
def test_system_controller_execute_open_url():
    sc = SystemController()
    with patch.object(sc, 'open_url', return_value="Opening URL: https://google.com") as mock_method:
        result = sc.execute_command("open_url", {"url": "https://google.com"})
        mock_method.assert_called_once_with("https://google.com")
        assert result == "Opening URL: https://google.com"
