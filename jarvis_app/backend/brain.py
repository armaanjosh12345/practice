...
class Brain:
    def __init__(self, db_path="jarvis_memory.db", llm_url="http://localhost:11434/api/generate"):
        ...
        # Persistent SQLite connection for better performance (avoiding open/close overhead)
        self.conn = sqlite3.connect(self.db_path, check_same_thread=False)
        # HTTP Session for connection pooling to Ollama API
    ...
    def get_history(self, limit=10):
        cursor = self.conn.cursor()
        # Using ORDER BY id DESC is faster as it uses the primary key index
    ...
    def think(self, user_input):
        ...
        - open_url: {"action": "open_url", "params": {"url": "https://www.google.com"}}
