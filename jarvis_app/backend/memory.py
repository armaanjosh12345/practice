...
class MemoryManager:
    ...
    def get_recent_history(self, limit=10):
        conn = sqlite3.connect(self.db_path)
        cursor = conn.cursor()
        # Optimization: Sorting by id (INTEGER PRIMARY KEY) is significantly faster than
        # sorting by a DATETIME column and achieves the same result for sequential insertions.
